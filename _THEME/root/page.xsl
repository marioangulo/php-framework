	...
	<xsl:template match="html">
		<html>
			<head>
				...
				<script language="javascript" src="root/search/init.js" type="text/javascript"></script>
                ...
                <!--theme-css-->
				<link href="_THEME/root/page.css" rel="stylesheet" type="text/css" />
					...
					<div class="topbar-inner">
						<div class="container">
							...
							<xsl:call-template name="xslt-include">
								<xsl:with-param name="href" select="string('../../root/tabs.html')"/>
							</xsl:call-template>
